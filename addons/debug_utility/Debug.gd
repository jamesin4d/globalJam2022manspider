...
class_name DebugPanel, "res://addons/debug_utility/icons/debug.png"

var debug_obj_script = preload("res://addons/debug_utility/debug_obj.gd")
...
func _ready():
	...
	add_child(create_obj("Object count", funcref(Performance, "get_monitor"), [8]))
	add_child(create_obj("3D count", funcref(Performance, "get_monitor"), [27]))
	add_child(HSeparator.new())
